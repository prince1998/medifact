...
public  class Pedo_New extends AppCompatActivity implements SensorEventListener{
    ...
    public void calories()
    {
        ...
        button.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                Toast.makeText(Pedo_New.this,Double.toString(calories), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onSensorChanged(SensorEvent sensorEvent)
    {
        ...
        if (!running)
        {
...

            {
                ...
                {
                    tv_steps.setText("No steps ta Sken");
                }
